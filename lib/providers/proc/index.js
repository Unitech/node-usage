...
function calculateCpuUsage(sysinfo, uptime, stat) {
  ...
  var totalTime = (stat.stime + stat.utime) / _SC_CLK_TCK;
  var processUptime = uptime - stat.startTime / _SC_CLK_TCK;
...
function calculateCpuUsageFromHistory(sysinfo, uptime, stat, lastUsage) {
  ...
  var totalTime = (stat.stime + stat.utime) / _SC_CLK_TCK;
  var lastTotalTime = (lastUsage.stat.stime + lastUsage.stat.utime) / _SC_CLK_TCK;
